...
FW::SpriteShader::SpriteShader():
  vao{0, 1},
  program{
    src_Graphics_Shaders_SpriteVertex_glsl,
    src_Graphics_Shaders_SpriteVertex_glsl_len,
    src_Graphics_Shaders_SpriteFragment_glsl,
    src_Graphics_Shaders_SpriteFragment_glsl_len
  }
{
